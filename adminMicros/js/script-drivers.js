...
const renderDriver = doc => {
    ...
    <tr data-id='${doc.id}'>
        ...
        <td>
            ...
            <button type="button" class="btn btn-delete btn-dark btn-icon-text">Eliminar
    ...
    btnDelete.addEventListener('click', () => {
        db.collection('Valid').doc(`${doc.id}`).delete().then(() => {
            console.log('Document succesfull deleted!!');
        }).catch(err => {
